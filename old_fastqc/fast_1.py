...
fastq_file="sample1.fq" #test file
# Compute line number
...
plt.savefig('2_QualityScoreDistributionOverAllSequences.jpg', format='jpg')
...
plt.legend(loc = 'upper right')
plt.savefig('3_SequenceContentAcrossAllBases.jpg',format='jpg')
...
plt.legend(loc = 'upper right')
plt.savefig('4_GCdistributionOverAllSequences.jpg',format='jpg')
